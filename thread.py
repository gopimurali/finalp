...
from reddit_analysis import collect_new_health_data
import threading
import time
from log_config import setup_logging
from reddit_comments import collect_reddit_diabetes_comments
from db import diabetes_comments_collection
...
def threaded_periodic_task():
    while True:
        collect_reddit_diabetes_comments(diabetes_comments_collection)
        time.sleep(interval_reddit_mins * 60)

def threaded_reddit_task():
    while True:
        try:
            collect_new_health_data()
